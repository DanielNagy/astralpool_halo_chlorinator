...
2. Wait paitently for your chlorinator to be discovered (should only be a few seconds once HA has started up)
3. When the halo device is detected in Home Assistant, click 'Configure'.
4. Go to your physical Halo Control Panel (the one near your pool)
...
6. It should then ask you what area the Halo is located, and be added to HA.
